                        ...
                        <div class="col-md-8">
                            <table class="table table-sm" style="font-size: 12px;">
                                <tr>
                                    ...
                                    <td><i class="mdi mdi-deskphone mr-3"></i>080 29292929</td>
                                </tr>
                                <tr>
                                    <td>6th Floor, Valencia City</td>
                                    <td><i class="mdi mdi-phone mr-3"></i> +91 7619379790</td>
                                </tr>
                                <tr>
                                    <td>Street P-4 Poblacion 88825</td>
                                    <td><i class="mdi mdi-email mr-3"></i> shravaniwedding@gmail.com</td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="col-md-12">
                        <!-- <form action="" method="post" style="font-size: 12px;">
                            <div class="row">
                                ...
                                <form action="" method="post" onsubmit="sendMessage(event)" style="font-size: 12px;">
    <div class="row">
        <div class="col-md-6">
            <div class="form-row">
                <div class="form-group col-md-12 mb-1">
                ...
                <!-- Hidden input field for the message -->
                <input type="hidden" id="hidden_message" name="hidden_message" value="Your message here">
            </div>
        </div>
        <div class="col-md-6 pr-2">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3951.804581750715!2d125.08993251421961!3d7.915471407613357!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x32ff1a2d27bfc2c5%3A0x49f6694edf036a5a!2sAMA+Computer+Learning+Center!5e0!3m2!1sen!2sph!4v1518944564341" width="95%" height="395" frameborder="0" style="border:0" allowfullscreen></iframe>
...
<script>
    function sendMessage(event) {
        ...
        // Your form submission logic here (e.g., sending data to server)
